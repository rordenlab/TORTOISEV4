#ifndef _WGPU_INVERTFIELD_CXX
#define _WGPU_INVERTFIELD_CXX

#include "invert_field.h"
#include "compose_fields.h"
#include "reductions.h"
#include "webgpu_context.h"
#include "invert_field.wgsl.h"
#include <vector>
#include <cstdio>
#include <cstdlib>
...
CUDAIMAGE::Pointer InvertField(CUDAIMAGE::Pointer field, CUDAIMAGE::Pointer initial_estimate)
{
    ...
    if(initial_estimate)
    {
        ...
        wgpuctx::CopyBuffer(output->getFloatdata().buf,
    ...
    while(iteration++ < Niter && max_error > max_tol && mean_error > mean_tol)
    {
        ...
        if(std::getenv("TORTOISE_WEBGPU_DEBUG"))
        {
