#ifndef _MTL_RESAMPLEIMAGE_CXX
#define _MTL_RESAMPLEIMAGE_CXX

#include "resample_image.h"
#include "metal_context.h"
#include "resample_image.metal.h"

// Uniform-buffer layout mirroring `struct Params` in resample_image.metal.
...
CUDAIMAGE::Pointer ResampleImage(CUDAIMAGE::Pointer main_field, CUDAIMAGE::Pointer virtual_img)
{
    ...
    mtlctx::ComputePipeline pipe =
        mtlctx::Pipeline("resample_image", kresample_imageMSL, "main_resample", wgx, wgy, wgz);
